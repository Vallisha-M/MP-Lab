...
NUMBER EQU ($-LIST) ;NUMBER OF ELEMENTS IN LIST
KEY DB 10H
...
AGAIN : MOV SI, OFFSET LIST
        XOR AX, AX ; A XOR A = 0 OR MOV AX, 00H
        CMP CL, CH ;COMPARE DO CL-CH
        JE NEXT    ;JUMP IF EQUAL
        JNC FAILED ;JUMP IF NO CARRY
...
NEXT  : MOV AL, CL
        ...
        JE SUCCESS           ; IF EQUAL, DISPLAY SUCESS MESSAGE
        JC INCLOW
